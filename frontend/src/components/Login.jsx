...
export default function Login() {
  ...
  return (
    <>
      <div className={`bg-[#353922] text-white  h-screen pt-20 flex items-center justify-center`}>
        <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center px-4">

          <div className="lg:w-1/2 flex justify-center lg:mb-0 transform transition duration-700 hover:scale-105">
            <img className="w-3/4" src="https://cdni.iconscout.com/illustration/premium/thumb/login-page-4468581-3783954.png" alt="Login Illustration" />
          </div>

          <div className="lg:w-1/2">
            <div className={`p-8 mr-10 rounded-lg shadow-md transform transition duration-100 hover:scale-105 rounded-xl border-gray-500 border-2 px-20 py-8 hover:shadow-md bg-[#2A2D1A] border-[#2A2D1A]`} >
              <p className="text-3xl font-semibold text-[#99ff00]  text-center mb-6">Login</p>
              ...
              <form action="" className=" space-y-6">
               ...
               <button type="submit" className="px-12 ml-48 font-bold rounded-md border-2 border-gray-400 bg-[#353922] text-white hover:bg-[#2A2D1A] hover:text-[#99ff00] font-bold py-3 " onClick={handleClick } ><a href="/"> Submit </a> </button>
                <a href="/signup" className="block text-center text-blue-500 hover:underline mt-4" > Forgot your password? </a>
